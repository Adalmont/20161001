...
public class ParametrosIniciales extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<div id=param>");
            out.println("<h3 id='tituloparam'> Parametros</h3>");
            out.println("<ul>");
            while (parametros.hasMoreElements()){
                String nompar= parametros.nextElement();
                String valpar= request.getParameter(nompar);
                out.println("<li>Parametro: "+nompar+"; Valor: "+valpar+"</li>");
            }
            out.println("</ul>");
            out.println("</div>");
            out.println("<br/>");
